			...
			<section className="flex justify-center min-h[100vh]">
				<form className=" flex flex-col gap-y-5 p-5 font-[inter] sm:w-150 min-h-screen">
					...
					<div className="text-center py-4">
						<button
							type="button"
							className="px-4 py-3 bg-[#2563EB] w-full text-white  rounded-lg hover:opacity-90 cursor-pointer"
						>
							Sign Up
						</button>
					</div>
					...
					<div className="flex flex-col justify-between">
						...
						<div className="flex flex-col justify-between gap-6 cursor-pointer ">
							...
							<button
								type="button"
								className="flex items-center gap-2 rounded-lg justify-center p-3 hover:bg-gradient-to-r  from-blue-300 via-slate-400 to-blue-400 cursor-pointer"
							>
								<FaApple size="20" />
								Continue with Apple
							</button>
